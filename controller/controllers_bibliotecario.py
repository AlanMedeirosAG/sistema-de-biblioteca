...
# Rota para logar um bibliotecario (POST /bibliotecario)
@bibliotecario_bp.route('/bibliotecario', methods=['POST'])
...
# Rota para obter novo bibliotecario (GET /bibliotecario)
...
# Rota para atualizar um bibliotecario (PUT /bibliotecario)
...
# Rota para deletar um bibliotecario (DELETE /bibliotecario)
